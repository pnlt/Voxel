...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CameraLook : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            rotationCharacter = playerCharacter.transform.rotation;
        ...
        private void Rotate(Vector2 mouseInput)
        {
            //Yaw.
            Quaternion rotationYaw = Quaternion.Euler(0.0f, mouseInput.x, 0.0f);
            //Pitch.
            Quaternion rotationPitch = Quaternion.Euler(-mouseInput.y, 0.0f, 0.0f);
            ...
            else
            {
                ...
                //Rotate character.
                playerCharacter.gameObject.transform.rotation *= rotationYaw;
            }
        ...
        [ServerRpc]
        private void RequestServerRpc(Vector2 mouseInput)
        {
            //Yaw.
            Quaternion rotationYaw = Quaternion.Euler(0.0f, mouseInput.x, 0.0f);
            //Pitch.
            ...
            if (smooth)
            {
                ...
                localRotation = Clamp(localRotation);
                //Interpolate character rotation.
                playerCharacter.gameObject.transform.rotation = Quaternion.Slerp(playerCharacter.gameObject.transform.rotation, rotationCharacter, Time.deltaTime * interpolationSpeed);
            }
            else
            {
                //Rotate local.
        ...
        private void RotationHandler(Vector2 mouseInput)
        {
            RequestServerRpc(mouseInput);
        }
